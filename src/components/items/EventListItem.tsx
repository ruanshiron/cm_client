...
import { bodyOutline, calendarClearOutline, closeOutline, helpCircleOutline, peopleCircleOutline, readerOutline, shirtOutline } from "ionicons/icons";
...
const EventListItem: React.FC<EventListItemProps> = ({ data }) => {
  const form = useEventForm(data);

  return (
    <>
      <IonItem onClick={() => form.setShowEventForm(true)} button detail={false}>
